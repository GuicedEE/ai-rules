...
4. Link discipline:
   - Use relative paths; do not place project-specific docs inside the RulesRepository submodule directory when used downstream.
...
## Examples
- When scaffolding a new host project README, include links to PACT.md, RULES.md, GUIDES.md, IMPLEMENTATION.md, and the RulesRepository submodule path.
