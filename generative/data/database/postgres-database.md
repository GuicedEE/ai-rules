...
* JPMS usage: Do not shade the PostgreSQL driver or Hibernate Validator. Use the GuicedEE Services JPMS artifacts instead (e.g., com.guicedee.modules.services:postgresql, com.guicedee.modules.services:hibernate-validator).
