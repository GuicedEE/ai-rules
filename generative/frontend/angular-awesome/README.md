# Angular Awesome — Components Index (Angular 19+)

This directory contains component-specific rule files for Angular Awesome — an Angular 19+ TypeScript plugin that provides Angular directives/components for the WebAwesome web components. Use this index to navigate directly to the relevant Angular wrapper rules for each WebAwesome component. Host projects should reference this directory when the framework/topic is “Angular Awesome.”
