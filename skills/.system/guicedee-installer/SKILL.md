...
4. Create or repair:
   ...
   - ensure DTO/JSON deserialization packages open to `tools.jackson.databind`
...
- Safe module rule: open used main packages to `com.google.guice`, `tools.jackson.databind`, and `com.guicedee.vertx`; include `org.junit.platform.commons` for test packages.
